...
document.getElementById("sketchtbd").innerHTML = sketch;
timer_counter = 0;
timer_check = "";
drawn_sketch = "";
answer_holder = "";
...
function draw(){
    ...
    if (drawn_sketch == sketch) {
        answer_holder = "set";
        score++;
        document.getElementById("rightsidescore").innerHTML = "Score:" + score;
    }
}

function check_sketch(){
   timer_counter++;
   document.getElementById("leftsidetime").innerHTML = "Time:" + timer_counter;
